...
func TestName_2024_01_09_14_59_43(t *testing.T) {
	// chan的基本用法
	// go test -run TestName_2024_01_09_14_59_43/chan_crud
	...
	// go test -run TestName_2024_01_09_14_59_43/1.read_no_buf
	...
	// go test -run TestName_2024_01_09_14_59_43/2.read_no_data
	...
	// go test -run TestName_2024_01_09_14_59_43/3.read_nil_chan
	...
	// 程写入管道时，阻塞的条件有3个：①管道无缓冲区②管道缓冲区已满③管道为nil。
	// go test -run TestName_2024_01_09_14_59_43/1.write_no_buf
	...
	// go test -run TestName_2024_01_09_14_59_43/2.write_full_data
	...
	// go test -run TestName_2024_01_09_14_59_43/3.write_nil_chan
	...
	// go test -run TestName_2024_01_09_14_59_43/1._write_to_a_closed_chan
	...
	// go test -run TestName_2024_01_09_14_59_43/2._close_a_closed_chan
	...
	// go test -run TestName_2024_01_09_14_59_43/2._read_from_a_close_chan
	t.Run("2. read from a close chan", func(t *testing.T) {
		var (
			ch1 chan int
			val int
			ok  bool
